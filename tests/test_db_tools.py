...
far = db.insert_item({"title": "Uzak", "due_date": (today + timedelta(days=5)).isoformat(),
                      "remind_before_days": 2}, amele_id=1)
...
# --- overdue ---
overdue = db.insert_item({"title": "Gecikmiş", "due_date": (today - timedelta(days=1)).isoformat()}, amele_id=1)
